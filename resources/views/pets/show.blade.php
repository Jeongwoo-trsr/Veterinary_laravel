...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('pets.edit', $pet->id) }}" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
    ...
    <div>
        ...
        <div class="p-6">
            ...
            <div class="border-t pt-6 mb-6">
                <h3 class="text-lg font-semibold mb-4 text-gray-800">Owner Information</h3>
