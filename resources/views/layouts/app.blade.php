    ...
    <div class="max-w-full px-6">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-6">
                ...
                <span class="bg-blue-600 text-white text-xs font-medium px-3 py-1.5 rounded-full">
                ...
                <div class="notification-bell" id="notificationBell">
                    <i class="fas fa-bell text-gray-700 text-xl hover:text-gray-900"></i>
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    @csrf
                    <button type="submit" class="flex items-center gap-2 text-gray-700 hover:text-gray-900 font-medium">
