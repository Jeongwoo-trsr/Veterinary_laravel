        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <form method="POST" action="{{ route('medical-records.update', $medicalRecord->id) }}" class="space-y-6">
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t">
                    <button type="button" onclick="history.back()" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                        Cancel
                    </button>
