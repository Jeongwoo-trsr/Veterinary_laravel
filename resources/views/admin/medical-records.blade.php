...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex justify-between items-center gap-4">
        <form method="GET" action="{{ route('admin.medical-records') }}" class="flex items-center gap-4 w-full">
            ...
            @if(request('search'))
                <a href="{{ route('admin.medical-records') }}" class="ml-3 px-3 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">Clear</a>
            @endif
        </form>
    </div>
...
(function(){
    ...
    const baseUrl = "{{ route('admin.medical-records') }}";
